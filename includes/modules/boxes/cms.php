<?php
/*
  $Id: cms.php,v 1.1 2011/08/30 21:13:25 ujirafika.ujirafika Exp $
...
*/
  ...
  class osC_Boxes_cms extends osC_Modules {
    ...
    function initialize() {
      ...
      $QcmsBuild = $osC_Database->query('select cms_url as url , cms_name as text from :table_cms where language_id = :language_id and active = 1 order by date_added DESC LIMIT :box_cms_limit');
      ...
      while ($QcmsBuild->next()) {
        ...
        $this->_content .= '<li>'. osc_link_object(osc_href_link(FILENAME_CMS, 'view=' . $QcmsBuild->value("url")), $QcmsBuild->value("text")) . '</li>';
      }

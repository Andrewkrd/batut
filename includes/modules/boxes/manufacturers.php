<?php
/*
  $Id: manufacturers.php,v 1.3 2012/09/09 20:58:39 ujirafika.ujirafika Exp $
...
*/
  ...
  class osC_Boxes_manufacturers extends osC_Modules {
    ...
    function initialize() {
      ...
      $Qmanufacturers = $osC_Database->query('select manufacturers_sef as id, manufacturers_name as text from :table_manufacturers where manufacturers_id > 0 order by manufacturers_name');
      ...
      $this->_content = '<form name="manufacturers" action="' . osc_href_link(FILENAME_DEFAULT, null, 'NONSSL', false) . '" method="get">' .
                        osc_draw_pull_down_menu('manufacturers', $manufacturers_array, null, 'onchange="location.href=\'index.php/manufacturers,\'+this.value" size="' . BOX_MANUFACTURERS_LIST_SIZE . '" style="width: 100%"') . osc_draw_hidden_session_id_field() .
                        '</form>';
    }

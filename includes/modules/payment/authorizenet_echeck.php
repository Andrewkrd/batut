<?php
/*
  $Id: authorizenet_echeck.php,v 1.1 2011/08/30 21:12:41 ujirafika.ujirafika Exp $
...
*/
  ...
  class osC_Payment_authorizenet_echeck extends osC_Payment {
    ...
    function _verifyData() {
      ...
      $_POST['authorizenet_echeck_routing_code'] = (isset($_POST['authorizenet_echeck_routing_code']) ? preg_replace('/[^0-9]/', '', $_POST['authorizenet_echeck_routing_code']) : '');//$_POST['authorizenet_echeck_routing_code'] = (isset($_POST['authorizenet_echeck_routing_code']) ? ereg_replace('[^0-9]', '', $_POST['authorizenet_echeck_routing_code']) : '');
      ...
      if (($error === false) && (MODULE_PAYMENT_AUTHORIZENET_ECHECK_VERIFY_WITH_WF_SS == '1')) {
        $_POST['authorizenet_echeck_tax_id'] = (isset($_POST['authorizenet_echeck_tax_id']) ? preg_replace('/[^0-9]/', '', $_POST['authorizenet_echeck_tax_id']) : '');//$_POST['authorizenet_echeck_tax_id'] = (isset($_POST['authorizenet_echeck_tax_id']) ? ereg_replace('[^0-9]', '', $_POST['authorizenet_echeck_tax_id']) : '');

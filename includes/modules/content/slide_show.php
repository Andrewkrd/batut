<?php
/*
  $Id: slide_show.php,v 1.2 2011/11/11 10:11:11 ujirafika.ujirafika Exp $
...
/* Class constructor */
    ...
    function initialize() {
      ...
      $Qimages = $osC_Database->query('select image ,image_url from :table_slides where language_id =:language_id and status = 1 order by rand()');//sort_order desc');

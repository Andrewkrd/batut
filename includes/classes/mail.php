<?php
/*
  $Id: mail.php,v 1.3 2012/02/05 19:56:23 ujirafika.ujirafika Exp $
...
*/
  ...
  class osC_Mail {
	...
	$this->_charset = $osC_Language->getCharacterSet(); //redefined osC3.05alfa core language charset to global
      if ( empty($this->_body) ) { //echo "plain" , $this->_body_plain . "html:" . $this->_body_html;
        if ( !empty($this->_body_plain) && !empty($this->_body_html) ) {
          ...
          $this->_body .= '--' . $this->_boundary . '--' . "\n";
        } elseif ( !empty($this->_body_html) ) { //echo "Yahoo!";
          $this->_headers['MIME-Version'] = '1.0';

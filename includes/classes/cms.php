<?php
/*
  $Id: cms.php,v 1.2 2013/02/22 20:42:11 ujirafika.ujirafika Exp $
...
//      $QcmsList->execute();
    ...
    function &getDetails() {
      ...
      $QcmsList = $osC_Database->query('select * from :table_cms where active = "1" and language_id = :language_id and cms_url = :request_url order by date_added DESC');
      $QcmsList->bindTable(':table_cms', TABLE_CMS);

<?php
/*
  $Id: address_book.php,v 1.2 2011/10/14 19:36:39 ujirafika.ujirafika Exp $
 ...
 */
    ...
    public static function &getListing() {
      ...
      $Qaddresses = $osC_Database->query('select 
      ab.address_book_id, 
      ...
      ab.entry_city as city,
       ...
       ab.entry_zone_id as zone_id, ab.entry_country_id as country_id from :table_address_book ab where ab.customers_id = :customers_id order by ab.entry_firstname, ab.entry_lastname');

<?php
/*
  $Id: template.php,v 1.3 2012/08/28 19:02:12 ujirafika.ujirafika Exp $
 ...
 */
    ...
    function &setup($module) {
      ...
      if(strpos($_SERVER["REQUEST_URI"], "magazin/")) {
      	$group = "products";
      	$module = "products";
      }
      ...
      if(strpos($_SERVER["REQUEST_URI"], "info/") || strpos($_SERVER["REQUEST_URI"], "info.php")) {
      	$group = "info";
      	if(strpos($_SERVER["REQUEST_URI"], "info/contact") !== false || strpos($_SERVER["REQUEST_URI"], "contact=showImage") !== false) 
      		$module = "contact";
      	elseif(strpos($_SERVER["REQUEST_URI"], "info/sitemap")) 
      		$module = "sitemap";
      	elseif(strpos($_SERVER["REQUEST_URI"], "info/cookie")) 
      		$module = "cookie";

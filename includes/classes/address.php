<?php
/*
  $Id: address.php,v 1.2 2011/10/14 19:36:39 ujirafika.ujirafika Exp $
 ...
 */
    ...
    public static function format($address, $new_line = null) {
      ...
      if ( is_numeric($address) ) {
        $Qaddress = $osC_Database->query('select ab.entry_firstname as firstname,
         ...
         from :table_address_book ab where ab.address_book_id = :address_book_id');

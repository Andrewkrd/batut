<?php
/*
  $Id: account.php,v 1.2 2012/02/03 21:13:51 ujirafika.ujirafika Exp $
...
*/
  ...
  if ($osC_Customer->isLoggedOn() === false) {
    ...
    if (empty($_GET) || (!empty($_GET) && !in_array(osc_sanitize_string(basename(key($first_array))), array('login', 'create', 'password_forgotten', 'unauth_order')))) {

<?php
/*
  $Id: info.php,v 1.2 2012/08/28 19:04:32 ujirafika.ujirafika Exp $
...
<ul style="padding-left: 100px; list-style-image: url(<?php echo osc_href_link('/templates/' . $osC_Template->getCode() . '/images/arrow_green.gif'); ?>);">
	...
	while ($QinfoList->next()) {
    	echo '<li><a href="' . osc_href_link("info/" . $QinfoList->value("info_url")) . '"> ' . $QinfoList->value("info_name") . '</a></li>';
    }

?>
      <li><?php echo osc_link_object(osc_href_link('info/contact'), $osC_Language->get('box_information_contact')); ?></li>
      <li><?php echo osc_link_object(osc_href_link('info/sitemap'), $osC_Language->get('box_information_sitemap')); ?></li>
    </ul>

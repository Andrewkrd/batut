<?php
/*
  $Id: reviews_new.php,v 1.3 2012/07/04 21:26:07 ujirafika.ujirafika Exp $
...
<form name="reviews_new" action="<?php echo osc_href_link(FILENAME_PRODUCTS, 'reviews=new&' . $osC_Product->getID() . '&action=process', 'NONSSL', false, false); ?>" method="post" onsubmit="return checkForm(this);">
...
?>
      ...
      <li><?php echo osc_draw_label("Email (не публикуется):", null, 'customer_email_address') . osc_draw_input_field('customer_email_address'); ?></li>

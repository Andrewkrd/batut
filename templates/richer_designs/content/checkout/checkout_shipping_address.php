<?php
/*
  $Id: checkout_shipping_address.php,v 1.2 2012/07/19 19:39:13 ujirafika.ujirafika Exp $
...
<form name="checkout_address" action="<?php echo osc_href_link(FILENAME_CHECKOUT, 'shipping_address=process', 'SSL', false, false); ?>" method="post" onsubmit="return check_form_optional(checkout_address);">

<?php
/*
  $Id: checkout_payment.php,v 1.2 2012/07/19 19:43:20 ujirafika.ujirafika Exp $
...
<form name="checkout_payment" action="<?php echo osc_href_link(FILENAME_CHECKOUT, 'confirmation', 'SSL', false, false); ?>" method="post" onsubmit="return check_form();">

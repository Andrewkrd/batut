<?php
/*
  $Id: checkout_confirmation.php,v 1.2 2012/07/19 19:43:20 ujirafika.ujirafika Exp $
...
?>
          <p><?php echo '<b>' . $osC_Language->get('order_delivery_address_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'shipping_address', 'SSL', false, false), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></p>
...
?>
          ...
          <p><?php echo '<b>' . $osC_Language->get('order_shipping_method_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'shipping', 'SSL', false, false), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></p>
...
?>
          ...
          <p><?php echo '<b>' . $osC_Language->get('order_billing_address_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'payment_address', 'SSL', false, false), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></p>
          <p><?php echo osC_Address::format($osC_ShoppingCart->getBillingAddress(), '<br />'); ?></p>

          <p><?php echo '<b>' . $osC_Language->get('order_payment_method_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'payment', 'SSL', false, false), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></p>
...
?>
              ...
              <tr>
                <td colspan="2"><?php echo '<b>' . $osC_Language->get('order_products_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, null, 'SSL', false, false), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></td>
...
?>
              ...
              <tr>
                <td colspan="3"><?php echo '<b>' . $osC_Language->get('order_products_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, null, 'SSL', false, false), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></td>
              </tr>
...
<div class="moduleBox">
  <h6><?php echo '<b>' . $osC_Language->get('order_comments_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'payment', 'SSL', false, false), '<span class="orderEdit">' . $osC_Language->get('order_text_edit_title') . '</span>'); ?></h6>
...
<?php
  if ($osC_Payment->hasActionURL()) {
    ...
    $form_action_url = osc_href_link(FILENAME_CHECKOUT, 'process', 'SSL', false, false);
  }

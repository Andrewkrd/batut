<?php
/*
  $Id: checkout_success.php,v 1.3 2012/07/19 19:43:20 ujirafika.ujirafika Exp $
...
<form name="order" action="<?php echo osc_href_link(FILENAME_CHECKOUT, 'success=update', 'SSL', false, false); ?>" method="post">

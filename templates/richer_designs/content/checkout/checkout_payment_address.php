<?php
/*
  $Id: checkout_payment_address.php,v 1.2 2012/07/19 19:43:20 ujirafika.ujirafika Exp $
...
<form name="checkout_address" action="<?php echo osc_href_link(FILENAME_CHECKOUT, 'payment_address=process', 'SSL', false, false); ?>" method="post" onsubmit="return check_form_optional(checkout_address);">

...
$VERSION='$Id: apc.php,v 1.1 2012/08/29 15:17:36 ujirafika.ujirafika Exp $';
...
defaults('USE_AUTHENTICATION',1);			// Use (internal) authentication - best choice if 
											...
											//  this work!
defaults('ADMIN_USERNAME','andrew'); 			// Admin Username
defaults('ADMIN_PASSWORD','1150388'); 			//Admin Password - CHANGE THIS TO ENABLE!!!

<?php
/*
  $Id: reviews.php,v 1.4 2012/01/08 21:37:58 ujirafika.ujirafika Exp $
    ...
    function _setData() {
      ...
      while ( $Qreviews->next() ) {
        $this->_data .= '    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">' .
                        ...
                        '      <td align="center">' . osc_image('/templates/' . $osC_Template->getCode() . '/images/stars_' . $Qreviews->valueInt('reviews_rating') . '.png', $Qreviews->valueInt('reviews_rating') . '/5') . '</td>' .

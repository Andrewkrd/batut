<?php
/*
  $Id: products.php,v 1.2 2012/04/02 20:30:19 ujirafika.ujirafika Exp $
...
/* Private methods */
    ...
    function _setData() {
      ...
      $Qproducts = $osC_Database->query('select products_id, greatest(products_date_added, products_last_modified) as date_last_modified from :table_products where parent_id = 0 order by date_last_modified desc limit 15');

<?php
/*
  $Id: saferpay_cc.php,v 1.1 2011/08/29 22:15:26 ujirafika.ujirafika Exp $
 ...
 */
    ...
    function osC_Payment_saferpay_cc() {
	  ...
	  $title1 = $osC_Language->get('payment_saferpay_cc_admin_1');
	  $title2 = $osC_Language->get('payment_saferpay_cc_admin_2');
	  $title3 = $osC_Language->get('payment_saferpay_cc_admin_3');
	  $title4 = $osC_Language->get('payment_saferpay_cc_admin_4');
	  $title5 = $osC_Language->get('payment_saferpay_cc_admin_5');
	  $title6 = $osC_Language->get('payment_saferpay_cc_admin_6');
	  $title7 = $osC_Language->get('payment_saferpay_cc_admin_7');
	  $title8 = $osC_Language->get('payment_saferpay_cc_admin_8');
	  $title9 = $osC_Language->get('payment_saferpay_cc_admin_9');
	  $title10 = $osC_Language->get('payment_saferpay_cc_admin_10');
	  $title11 = $osC_Language->get('payment_saferpay_cc_admin_11');
	  $title12 = $osC_Language->get('payment_saferpay_cc_admin_12');
	  $title13 = $osC_Language->get('payment_saferpay_cc_admin_13');
	  $title14 = $osC_Language->get('payment_saferpay_cc_admin_14');
	  $title15 = $osC_Language->get('payment_saferpay_cc_admin_15');
	  $title16 = $osC_Language->get('payment_saferpay_cc_admin_16');	
	...
	if (($configuration_title & $configuration_description) != ($titlex & $titley)) {		  
	  ...
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title1', configuration_description = '$title9' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_STATUS'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title2', configuration_description = '$title10' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_ACCOUNT_ID'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title3', configuration_description = '$title11' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_PASSWORD'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title4', configuration_description = '$title12' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_ACCEPTED_TYPES'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title5', configuration_description = '$title13' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_VERIFY_WITH_CVC'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title6', configuration_description = '$title14' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_ZONE'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title7', configuration_description = '$title15' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_ORDER_STATUS_ID'");
	  $osC_Database->simpleQuery("UPDATE " . TABLE_CONFIGURATION . " SET configuration_title = '$title8', configuration_description = '$title16' WHERE configuration_key = 'MODULE_PAYMENT_SAFERPAY_CC_SORT_ORDER'");  

<?php
/*
  $Id: main.php,v 1.2 2011/09/05 09:03:32 ujirafika.ujirafika Exp $
...
?>
      ...
      <td align="center"><?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/stars_' . $Qreviews->valueInt('reviews_rating') . '.png', sprintf($osC_Language->get('rating_from_5_stars'), $Qreviews->valueInt('reviews_rating'))); ?></td>

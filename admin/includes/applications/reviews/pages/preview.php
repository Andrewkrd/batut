<?php
/*
  $Id: preview.php,v 1.2 2011/09/05 09:03:32 ujirafika.ujirafika Exp $
...
<p><?php echo '<b>' . $osC_Language->get('field_rating') . '</b>&nbsp;' . osc_image('templates/' . $osC_Template->getCode() . '/images/stars_' . $osC_ObjectInfo->get('reviews_rating') . '.png', sprintf($osC_Language->get('rating_from_5_stars'), $osC_ObjectInfo->get('reviews_rating'))) . '&nbsp;[' . sprintf($osC_Language->get('rating_from_5_stars'), $osC_ObjectInfo->get('reviews_rating')) . ']'; ?></p>

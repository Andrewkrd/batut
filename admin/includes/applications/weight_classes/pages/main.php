<?php
/*
  $Id: main.php,v 1.1 2011/08/29 22:16:00 ujirafika.ujirafika Exp $
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable">
  <thead>
    <tr>
      <th align="left"><?php echo $osC_Language->get('table_heading_weight_classes'); ?></th>
...
?>
    ...
    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">
      ...
      <td align="center"><?php echo $Qclasses->value('weight_class_key'); ?></td>
      <td align="right">

<?php
/*
  $Id: main.php,v 1.1 2011/08/29 22:01:42 ujirafika.ujirafika Exp $
...
<div align="right">
  ...
  <input type="submit" value= <?php echo $osC_Language->get('button_use') ?> class="operationButton" />
...
?>
    ...
    <tr onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">
      ...
      <td align="center"><?php echo $Qlog->valueProtected('user_name'); ?></td>
      <td align="center"><?php echo date('d.m.Y H:i:s', $Qlog->value('datestamp')); ?></td>
      <td align="right">

<?php
/*
  $Id: main.php,v 1.2 2012/04/02 20:30:16 ujirafika.ujirafika Exp $
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="productsDataTable">
  <thead>
    <tr>
      ...
      <th align="center" width="20">Статус</th>
    </tr>
  </thead>
  <tfoot>
    <tr>
...
<script type="text/javascript"><!--
  ...
  function feedDataTable(data) {
    ...
    for ( var r in data.entries ) {
      ...
      newCell.innerHTML = '<a href="' + productEditLink.replace('PRODUCTID', parseInt(record.products_id)) + '">' + htmlSpecialChars(record.products_name) + '</a> <a href="' + productLink.replace('PRODUCTID', parseInt(record.products_id)) + '">&nbsp;' + useProductLinkIcon + '&nbsp;</a>';
      ...
      if(record.products_status)
      	newCell.innerHTML = '<img src="templates/default/images/icons/16x16/checkbox_ticked.gif" />'
      else
    	newCell.innerHTML = '<img src="templates/default/images/icons/16x16/checkbox_crossed.gif" />'
      newCell.align = 'center';

<?php
/*
  $Id: customers.php,v 1.2 2011/11/25 19:41:13 ujirafika.ujirafika Exp $
...
*/
  ...
  class osC_Customers_Admin {
    ...
    public static function getAddressBookData($customer_id, $address_book_id = null) {
      ...
      $Qab = $osC_Database->query('select ab.address_book_id, 
      ab.entry_gender as gender, ab.entry_firstname as firstname, ab.entry_lastname as lastname, 
      ...
      ab.entry_state as state, ab.entry_telephone as telephone_number, ab.entry_fax as fax_number from :table_address_book ab where');
      ...
      $Qab->appendQuery('ab.customers_id = :customers_id');

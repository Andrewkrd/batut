<?php
/*
  $Id: save.php,v 1.4 2012/09/11 20:06:44 ujirafika.ujirafika Exp $
  ...
  class osC_Application_Categories_Actions_save extends osC_Application_Categories {
    public function __construct() {
      ...
      if ( isset($_POST['subaction']) && ($_POST['subaction'] == 'confirm') ) {
        ...
        if(isset($_POST['categories_text']))
        	$data["categories_text"] = $_POST['categories_text'];
        else 
        	$data["categories_text"] = "";
        	
        	
        if(isset($_POST['categories_text_top']))
        	$data["categories_text_top"] = $_POST['categories_text_top'];
        else 
        	$data["categories_text_top"] = "";
        	
        if(isset($_POST['categories_title']))
        	$data["categories_title"] = $_POST['categories_title'];
        else 
        	$data["categories_title"] = "";
        	
        if(isset($_POST['kissmt_categories_description']))
        	$data["kissmt_categories_description"] = $_POST['kissmt_categories_description'];
        else 
        	$data["kissmt_categories_description"] = "";

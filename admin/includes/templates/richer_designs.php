<?php
/*
  $Id: richer_designs.php,v 1.1 2011/08/30 20:29:11 ujirafika.ujirafika Exp $
...
*/
  ...
  class osC_Template_richer_designs {
    var $_id,
        $_title = 'Richer Designs Template',
        $_code = 'richer_designs',
